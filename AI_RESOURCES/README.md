...
- `Skills/` for repo-specific agent skills.
- `Scripts/` for safe repeatable helper scripts.
- `Templates/` for reusable project templates, prompts, reports, or review evidence.
